              ...
              {loadingDetails || !activeCase ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-b border-gray-200 flex space-x-6">
                    {(['notes', 'documents', 'billing'] as const).map((tab) => (
                      <button
                        key={tab}
                      ...
                      >
                        {tab} {tab === 'notes' && `(${activeCase.notes?.length || 0})`}
                        {tab === 'documents' && `(${activeCase.documents?.length || 0})`}
                        {tab === 'billing' && `(${activeCase.billing_entries?.length || 0})`}
                      </button>
                    ))}
                  </div>
                  ...
                  <div>
                    ...
                    {activeTab === 'documents' && (
                      <CaseDocumentsTab
                        ...
                        onDocumentUploaded={refreshActiveCase}
                      />
                    )}
                    {activeTab === 'billing' && (
                      <CaseBillingTab
                        ...
                        onEntryAdded={refreshActiveCase}
                      />
                    )}
                  </div>
                </div>
